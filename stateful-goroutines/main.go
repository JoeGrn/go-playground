...
// State in this example is owned by a single goroutine, guaranteeing that the data is never corrupted with concurrent access.
...
func main() {
	...
	// Then sending a value on the response channel resp to indicate success (and the desired value in the case of reads)
	go func() {
