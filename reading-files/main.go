...
// Helper func to assist with that.
func check(e error) {
	if e != nil {
		panic(e)
	}
...
func main() {
	...
	// bufio package implements a buffered reader
	// this may be useful both for its efficiency with many small reads and because of the additional reading methods it provides
